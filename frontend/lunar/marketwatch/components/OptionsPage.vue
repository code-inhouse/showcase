      ...
      <Tabs class="push-bottom">
        ...
        <section btn-class="icon-submit" btn-name="Telegram API">
          ...
          <div class="form-input push-bottom">
            ...
            <input class="flex-1" type="text" placeholder="00000:xxxxx..." v-model="options.telegram.botkey_placeholder" @blur="saveOptions()" />
          </div>
          <div class="form-input push-bottom">
...
export default {
  ...
  data() {
    return {
      ...
      audioFiles: [
        { text: 'Audio 1', value: '/static/assets/marketwatch/audio/audio_1.mp3' },
        { text: 'Audio 2', value: '/static/assets/marketwatch/audio/audio_2.mp3' },
        { text: 'Audio 3', value: '/static/assets/marketwatch/audio/audio_3.mp3' },
        { text: 'Audio 4', value: '/static/assets/marketwatch/audio/audio_4.mp3' },
        { text: 'Audio 5', value: '/static/assets/marketwatch/audio/audio_5.mp3' },
      ]
    }
  },
  ...
  methods: {
    ...
    askNotifyPermission( e ) {
      ...
      this.$marketwatchNotify.permission( status => {
  ...
  mounted() {
    ...
    this.canNotify = this.$marketwatchNotify.canNotify();
  },
}
</script>
