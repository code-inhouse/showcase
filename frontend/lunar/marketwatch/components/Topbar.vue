<template>
  <header class="topbar-wrap" :class="{ 'collapsed': header.collapsed }">
    <div class="container topbar-wrap__padding">
...
export default {
  ...
  computed: {
    ...
    assetPrices() {
      ...
      return this.$utils.sort( list, 'assetVolume', 'desc' ).slice( 0, 10 );
    },
  },
...
.topbar-wrap {
  ...
  .topbar-main {
    ...
    // top asset prices
    .topbar-prices .text-clip .text-bright {
        font-size: 1.2rem;
    }
