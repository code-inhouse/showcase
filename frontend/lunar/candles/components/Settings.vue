        ...
        <div class="mt15 settings__footer flex-middle">
          <div class="form-group">
            <div v-if="version.number">
              <span>
                Lunar Labs
                <sup class="version-date">Alpha</sup>
              </span>
              <i class="divider">|</i>
    ...
    .checkbox-control {
      ...
      > div {
        ...
        &:not([class^='icon-']):before {
          content: unicode($candles-icon-check);
        }
      ...
      &.-luminosity {
        input {
          ~ div {
            ...
            &:before {
              content: unicode($candles-icon-day);
            }

            &:after {
              content: unicode($candles-icon-night);
            }
          }
      ...
      &.-on-off input ~ div {
        &:before {
          content: unicode($candles-icon-power-on);
        }

        &:after {
          content: unicode($candles-icon-power-off);
        }
      }
